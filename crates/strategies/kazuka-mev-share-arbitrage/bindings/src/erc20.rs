    ...
    impl alloy_sol_types::SolInterface for ERC20Calls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<ERC20Calls>] = &[
                ...
                },
                {
                    fn DOMAIN_SEPARATOR(
                        ...
                        <DOMAIN_SEPARATORCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20Calls::DOMAIN_SEPARATOR)
                    }
                    DOMAIN_SEPARATOR
                },
                {
                ...
                {
                    fn nonces(data: &[u8]) -> alloy_sol_types::Result<ERC20Calls> {
                        <noncesCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20Calls::nonces)
                    }
                    nonces
                },
                {
                ...
                {
                    fn permit(data: &[u8]) -> alloy_sol_types::Result<ERC20Calls> {
                        <permitCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20Calls::permit)
                    }
                    permit
                },
                {
